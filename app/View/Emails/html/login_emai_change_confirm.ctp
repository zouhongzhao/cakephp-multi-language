                ...
                <!-- [ middle starts here] -->
                    <tr>
                        <td valign="top">
                            ...
                            <p style="font-size:12px; line-height:16px; margin:0 0 16px 0;">You have request to change a new login E-mail address to this address, to confirm this action please visit the link below:</p>
